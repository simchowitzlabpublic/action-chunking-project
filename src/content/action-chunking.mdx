...
$$
J_{\text{demo}}^T(\hat{\pi}_{\text{chunk}}; \mathcal{P}_{\text{exp}}) = \mathbb{E}_{\mathcal{P}_{\text{exp}}}\left[ \sum_{k=1}^{(T-1)/\ell} \|\mathbf{u}^*_{1+(k-1)\ell:k\ell} - \text{chunk}[\hat{\pi}_{\text{chunk}}](\mathbf{x}^*_{(k-1)\ell})\|^2\right].
$$
...
$$
J_{L^2}^T(\hat{\pi}_{\text{chunk}}) \leq O^*(1)J_{\text{demo}}^T(\hat{\pi}_{\text{chunk}}; \mathcal{P}_{\text{exp}}).
$$
