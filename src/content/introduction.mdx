...
**TODO: Insert AC Figure from Slack**
...
We show that a simple noise-injection procedure suffices to prevent compounding errors, even when the underlying environment is not inherently stabilizing, provided that the expert demonstrator is capable of correcting from errors.
</Block>
